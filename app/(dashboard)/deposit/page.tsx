...
const DepositDashboard = () => {
 ...
 const coins: CryptoCoin[] = [
   ...
   { id: "btc", symbol: "BTC", name: "Bitcoin", icon: "B", color: "from-orange-400 to-orange-600" },
   { id: "eth", symbol: "ETH", name: "Ethereum", icon: "E", color: "from-purple-400 to-purple-600" },
 ...
 return (
   <div className="min-h-screen bg-background mb-20 text-white p-4 md:p-8">
     <div className="max-w-7xl mx-auto">
       <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
         ...
         <div className="lg:col-span-2 bg-[#1a1a1a] rounded-lg p-6">
           <div className="space-y-6">
                 ...
                 <div className="absolute z-10 mt-1 w-full bg-[#0a0a0a] border border-[#333] rounded-md shadow-lg max-h-60 overflow-auto">
                   {coins.map((coin) => (
                     ...
                     >
                       ...
                       {selectedCoin.id === coin.id && <Check className="h-4 w-4 text-green-500" />}
                     </div>
                   ))}
                 </div>
               )}
                 ...
                 <div className="absolute z-10 mt-1 w-full bg-[#0a0a0a] border border-[#333] rounded-md shadow-lg max-h-60 overflow-auto">
                   {networks.map((network) => (
                     ...
                     >
                       ...
                       {network.description && <p className="text-sm text-gray-400 mt-1">{network.description}</p>}
                     </div>
                   ))}
                 </div>
               )}
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div>
                 <label className="block text-white mb-2">Expected Arrival</label>
             ...
             <div>
               <label className="block text-white mb-2">Network</label>
               <p className="text-white">Make sure the network is {selectedNetwork.name}</p>
             </div>
           </div>
         </div>
         ...
         <div className="bg-[#1a1a1a] rounded-lg p-6">
           <div className="space-y-6">
             <h2 className="text-sm font-medium border-b border-[#333] pb-4">Facing Deposit Issues?</h2>
             ...
             <div className="space-y-4 text-sm">
               <h3 className="text-sm font-medium">Need Further Assistance?</h3>
               <ul className="list-disc pl-5 space-y-2 text-gray-300">
                 <li>Contact our Support Team.</li>
                 <li>
                   Familiarize yourself with common issues related to cryptocurrencies deposited with incorrect or
                   missing information.
                 </li>
             ...
             <div className="mt-8">
               <Button className="w-full bg-[#333] hover:bg-[#444] text-white border-none">Contact Support</Button>
             </div>
           </div>
         </div>
       </div>
