...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "OKX operates with various licenses and regulatory approvals in different jurisdictions. For the most up-to-date information about OKX is regulatory status in the US, please visit our regulatory compliance page.",
  },
  {
